...
//     () => (
//       <div className="h-[90px] w-[180px] rounded bg-gray-300 dark:bg-gray-600" />
//     ),
//     [],
//   );
...
//     return (
//       <div className="random-dims-x81pz flex flex-col space-y-1">
...
//         <svg
//           className="random-svgtrans-p57kx relative block h-12 w-full md:h-16"
//           data-name="Layer 1"
...
//       <footer className="unique-footer-h49sl relative rounded-t-3xl bg-app-text pb-5 pt-8 shadow-inner">
...
//               <h3
//                 className={`text-lg font-semibold text-white dark:text-gray-100 ${isLoading ? "opacity-75" : "opacity-100"}`}
//               >
...
//           <div className="mt-8 border-t border-white/20 pt-6 dark:border-gray-700 sm:mb-2">
      ...
      <footer className="relative rounded-t-3xl bg-app-text pb-3 pt-8 shadow-inner">
        <div className="mx-auto w-full max-w-7xl px-4">
          <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-4">
              <h3
                className={`text-lg font-semibold text-white dark:text-gray-200 ${isLoading ? "opacity-75" : "opacity-100"}`}
              >
                {footerSettings?.col1Heading || t("quickLinks")}
              </h3>
              <div className="mb-2 h-0.5 w-10 rounded-full bg-app-button"></div>
