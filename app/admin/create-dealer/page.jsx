          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="form-group">
                <label
                  htmlFor="map"
                  className="mb-1 block text-sm font-medium text-app-text mb-1"
                >
                  Map (Optional)
                </label>
                <div className="relative">
                  ...
                  <textarea
                    ...
                    value={formData.map}
                    onChange={handleChange}
className={`w-full border ${errors.map ? "border-red-500" : "border-gray-300"} rounded-md pl-10 pr-3 py-3 focus:outline-none focus:ring-1 focus:ring-app-button`}                    placeholder="Enter Google Maps URL or paste iframe embed code..."
                  />
                </div>
                {errors.map && (
