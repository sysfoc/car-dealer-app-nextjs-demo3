        ...
        <div className="space-y-4">
          {currentMessages.length === 0 ? (
            <div className="rounded-2xl border border-gray-200 bg-white p-8 sm:p-12 text-center shadow-sm">
              ...
              <h3 className="mb-2 text-base sm:text-lg font-semibold text-gray-900">No messages found</h3>
                  ...
                  <div className="mb-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className="text-base sm:text-lg font-semibold text-gray-900 truncate">{message.name}</h3>
            ...
            {selectedMessage && (
              <>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="rounded-lg border border-gray-200 bg-gray-50 p-3 sm:p-4">
                    <h4 className="mb-2 text-sm sm:text-base font-medium text-gray-900">Message Status</h4>
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-3 sm:p-4">
                  <h4 className="mb-3 text-sm sm:text-base font-medium text-gray-900">Original Message</h4>
